...
public class Restore_IP_Addresses {
	 ...
	 * NP like problem
	 * 
	 * Recursion + Pruning, thought is how to split the String, solution is use
	 * a similar way like permutation
	 * 
	 * Because a ip only has 4 parts, so the recursion depth can't be more than
	...
	public static void cutIP(String s, int start, Stack<String> ip,
		...
		for (int i = start + 1; i < s.length(); i++) {
			...
			// ignore splitting substring begin with '0' can avoid repeated cases
