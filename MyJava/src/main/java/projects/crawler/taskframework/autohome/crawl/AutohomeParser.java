package projects.crawler.taskframework.autohome.crawl;
...
import projects.crawler.utils.ExportUtils;
...
//    String[] fields = { "title", "brand", "phone", "address", "city", "promotion" };
    ExportUtils.exportDealersToCsv("dealers_nationwide.csv", dao);
  }
  ...
  public List<DealerPost> parsePosts(Document page, City city) throws ParseException {
    ...
    for (Element postElem : postElements) {
      ...
      ReflectionUtils.extractAndApplyValues(post, postElem, DealerListSchema.class);
  ...
  public boolean parseDealerInfo(Document page, DealerPost dealerInfo) {
    ...
    return ReflectionUtils.extractAndApplyValues(dealerInfo, page.body(), DealerInfoSchema.class);
  }
