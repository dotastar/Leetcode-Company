package projects.crawler.taskframework.forum;
...
public class MeetQunPostCrawler extends PostCrawler {
	...
	protected static final int MAX_PAGE = 200;
	...
	public void crawlPostsToFile(String root) {
		...
		String fileName = PostCrawler.ROOT_DIRECTORY + "mq-" + dateFormat.format(Calendar.getInstance().getTime()) + ".html";
