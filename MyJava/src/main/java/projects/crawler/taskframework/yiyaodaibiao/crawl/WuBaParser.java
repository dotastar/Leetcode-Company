package projects.crawler.taskframework.yiyaodaibiao.crawl;
...
import projects.crawler.taskframework.yiyaodaibiao.model.Job;
...
public class WuBaParser {
  ...
  public void testParseJob_NoPhone() throws IOException, ParseException {
    ...
    JobPost post = new JobPost(new ObjectId(), "Fake post title", "Fake company name", "Fake district", "Fake date", url, "Fake parent url", "Beijing",
        "Beijing");
  ...
  public void testParseJob_HasPhone() throws IOException, ParseException {
    ...
    JobPost post = new JobPost(new ObjectId(), "Fake post title", "Fake company name", "Fake district", "Fake date", url, "Fake parent url", "GuangZhou",
        "GuangDong");
    Document doc = Jsoup.connect(url).userAgent(USER_AGENT).get();
    Job job = parseJob(doc, post);
    System.out.println(job);
